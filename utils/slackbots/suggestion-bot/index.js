            ...
            case 'POST': {
                ...
                switch (eventBody.type) {
                  ...
                  case 'event_callback': {
                    ...
                    const {type, user, channel, text, bot_id, ts, client_msg_id, thread_ts} = eventBody.event;

                    if(type === 'message') {

                      if(channel == CHANNEL_ID && typeof bot_id == 'undefined' && typeof client_msg_id !== 'undefined'
                                ...
                                "blocks": [
                                    {
                                        ...
                                        "text": {
                                            "type": "mrkdwn",
                                            "text": ":wave: This app gives suggestions on which channels to join based on volunteers' introductions. It's just a simple keyword match that won't persist any data about you."
                                        }
                                    },
                                    {
                                        "type": "divider"
                                    },
                                    {
                                        ...
                                        "text": {
                                            "type": "mrkdwn",
                                            "text": "If you'd like to contribute, you can find the code here. Feel free to make a PR, but you'll have to reach out to @Katie since she's hosting it."
                                        }
                                    },
                                    {
                                        "type": "context",
                      ...
                      let result = await axios.post(`${API_URL}/views.publish`, qs.stringify(args));
                      console.log(result);
                    }
                    break;
                  }
